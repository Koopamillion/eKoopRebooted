...
public class GuiCentrifuge extends GuiContainer {
    ...
    private static final ResourceLocation background = new ResourceLocation(MyMod.MODID, "textures/gui/centrifuge.png");

    private static final ResourceLocation centrifugeprogressbar = new ResourceLocation(MyMod.MODID, "textures/gui/centrifugeprogressbar.png");
    ...
    private TileCentrifuge chicken;




    public GuiCentrifuge(TileCentrifuge tileEntity, ContainerCentrifuge container) {
        super(container);
    ...
    private void drawIdleBar(int idler, int rote, int crafter) {
        ...
        int percentage = idler * 36 / TileCentrifuge.MAX_RPM;
