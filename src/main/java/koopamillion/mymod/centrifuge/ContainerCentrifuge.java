...
public class ContainerCentrifuge  extends Container   {
    ...
    public ContainerCentrifuge(IInventory playerInventory, TileCentrifuge te) {
        this.te = te;
    ...
    public ItemStack transferStackInSlot(EntityPlayer playerIn, int index) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if (index < TileCentrifuge.SIZE) {
                if (!this.mergeItemStack(itemstack1, TileCentrifuge.SIZE, this.inventorySlots.size(), true)) {
                    return ItemStack.EMPTY;
                }
            } else if (!this.mergeItemStack(itemstack1, 0, TileCentrifuge.SIZE, false)) {
                return ItemStack.EMPTY;
            }
