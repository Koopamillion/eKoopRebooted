...
public class ItemEnderIngot extends Item {
    private static final Pattern COMPILE = Pattern.compile("@", Pattern.LITERAL);

    public ItemEnderIngot() {
        this.setCreativeTab(MyMod.tabEKoop);
        setRegistryName("enderingot");        // The unique name (within your mod) that identifies this item
        setTranslationKey(MyMod.MODID + ".enderingot");     // Used for localization (en_US.lang)
