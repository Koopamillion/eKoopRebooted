...
import koopamillion.mymod.centrifuge.CentrifugeTESR;
...
public class BlockBallmill extends Block implements ITileEntityProvider {

    public static final AxisAlignedBB CHICKEN_AABB= new AxisAlignedBB(0.1875D,0,0.1875D,0.8125D,0.875d,0.8125D);
    public static final ResourceLocation ballmill = new ResourceLocation(MyMod.MODID, "ballmill");
    public static final PropertyDirection FACING = BlockHorizontal.FACING;


    public BlockBallmill() {
        super(Material.WOOD);
        setRegistryName(ballmill);
        setTranslationKey(MyMod.MODID + ".ballmill");
    ...
    public void initModel() {
        ...
        ClientRegistry.bindTileEntitySpecialRenderer(TileBallmill.class, new BallimllTESR());
